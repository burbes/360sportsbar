...
/*
 * ***********************************************
 * Objetivo:     Açoes do Cadastro de Automação e Tec.
...
switch ($acao) {
    ...
    case 'Inserir':
        ...
        if ($_FILES['file']['name'] != null) {
            $file = AutoTec::carregaArquivo($condicoes);
    ...
    case 'Atualizar':
        ...
        if ($_POST && !isset($file['result']) || ($file['result'] == true && $_POST)) {
            ...
            $ok = AutoTec::atualizar($_POST, $condicoes);
        }
