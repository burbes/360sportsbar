...
/*
 * ***********************************************
 * Objetivo:     Açoes do Cadastro de Bebidas
...
switch ($acao) {
    ...
    case 'Inserir':
        ...
        if ($_FILES['file']['name'] != null) {
            $file = Bebidas::carregaArquivo($condicoes);

            $id_imagem = Bebidas::salvaImg(Array(
    ...
    case 'Atualizar':
        ...
        if ($_FILES['file']['name'] != null) {
            ...
            $id_imagem = Bebidas::atualizaImg(Array(/* $dados */
        ...
        if ($_POST && !isset($file['result']) || ($file['result'] == true && $_POST)) {
            /* FÇ ATUALIZA OS DADOS */
            $ok = Bebidas::atualizar($_POST, $condicoes);
        } else
            return false;
    ...
    case 'Remover':
        /* FÇ REMOVE IMG */
        $remImg = Bebidas::removerImg(Array(
