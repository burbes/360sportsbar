...
/*
 * ***********************************************
 * Objetivo:     Açoes do Cadastro de Apoio Juridico
...
switch ($acao) {
    ...
    case 'Inserir':
        ...
        if ($_FILES['file']['name'] != null) {
            $file = Apoio_Juridico::carregaArquivo($condicoes);
        ...
        if ($_POST && !isset($file['result']) || ($file['result'] == true && $_POST)) {
            $ok = Apoio_Juridico::inserir($_POST);
        } else
            return false;
    ...
    case 'Atualizar':
         ...
         * [dirType]: MOVER PARA PASTA DE IMAGENS */
        $condicoes = Array("ID_APOIOJURIDICO" => $_POST['ID_APOIOJURIDICO'], "sqlInjection" => FALSE, "dirType" => 'img');
        ...
        if ($_POST && !isset($file['result']) || ($file['result'] == true && $_POST)) {
            ...
            $ok = Apoio_Juridico::atualizar($_POST, $condicoes);
        } else
            return false;
    ...
    case 'Remover':
        /* CONDIÇÕES PARA ATUALIZAR */
        $id = Array("ID_APOIOJURIDICO" => $_POST['ID_APOIOJURIDICO']);

        /* FÇ ATUALIZA OS DADOS */
        $ok = Apoio_Juridico::remover($id);
