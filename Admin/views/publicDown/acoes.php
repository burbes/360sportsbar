...
/*
 * ***********************************************
 * Objetivo:     Açoes do Cadastro de publicações
 *               e downloads
...
switch ($acao) {
    ...
    case 'Inserir':
        ...
        if ($_FILES['file']['name'] != null) {
            $file = PublicDown::carregaArquivo($condicoes);
    ...
    case 'Atualizar':
         ...
         * [dirType]: MOVER PARA PASTA DE IMAGENS */
        $condicoes = Array("ID_AUTOTEC" => $_POST['ID_AUTOTEC'], "sqlInjection" => FALSE, "dirType" => 'img');
        ...
        if ($_POST && !isset($file['result']) || ($file['result'] == true && $_POST)) {
            ...
            $ok = PublicDown::atualizar($_POST, $condicoes);
        }
    ...
    case 'Remover':
        /* CONDIÇÕES PARA ATUALIZAR */
        $id = Array("ID_AUTOTEC" => $_POST['ID_AUTOTEC']);

        /* FÇ ATUALIZA OS DADOS */
        $ok = PublicDown::remover($id);
