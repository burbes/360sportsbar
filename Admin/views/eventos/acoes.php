...
/*
 * ***********************************************
 * Objetivo:     Açoes do Cadastro de Eventos
...
switch ($acao) {
    ...
    case 'Inserir':
        ...
        if ($_FILES['file']['name'] != null) {
            $file = Eventos::carregaArquivo($condicoes);
    ...
    case 'Atualizar':
         ...
         * [dirType]: MOVER PARA PASTA DE IMAGENS */
        $condicoes = Array("ID_EVENTO" => $_POST['ID_EVENTO'], "sqlInjection" => FALSE, "dirType" => 'img');
        ...
        if ($_POST && !isset($file['result']) || ($file['result'] == true && $_POST)) {
            ...
            $ok = Eventos::atualizar($_POST, $condicoes);
        } else
            return false;
    ...
    case 'Remover':
        /* CONDIÇÕES PARA ATUALIZAR */
        $id = Array("ID_EVENTO" => $_POST['ID_EVENTO']);

        /* FÇ ATUALIZA OS DADOS */
        $ok = Eventos::remover($id);
