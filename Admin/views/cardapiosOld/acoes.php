...
/*
 * ***********************************************
 * Objetivo:     Açoes do Cadastro de Cardapios
...
switch ($acao) {
    ...
    case 'Inserir':
        ...
        if ($_FILES['file']['name'] != null) {
            $file = Cardapios::carregaArquivo($condicoes);
    ...
    case 'Atualizar':
        ...
        if ($_POST && !isset($file['result']) || ($file['result'] == true && $_POST)) {
            ...
            $ok = Cardapios::atualizar($_POST, $condicoes);
        } else
            return false;
