/*
 * ***********************************************
 * Objetivo:     Carrega as funções JS dos Beneficios
 *               
...
var objBeneficios = function() {
    return {
        ...
        fnOpenFormEdit: function(id) {
            ...
            var dados = eval("(" + $("#hddBeneficio" + id).val() + ")");
        ...
        fnSubmitForm: function() {
            ...
            /* CAMPOS OBRIGATORIOS */
            var condicoesCampoObrigatorio = new Array('txtTitulo', 'txtAreaDescricao');
