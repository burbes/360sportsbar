 ...
 *
 *    Obs: pra reduzir por ambas as extremidades, você deverá passar dois valores no quarto parâmetro da função. 
 *    Para isso, utilize o operador bit a bit "|" desta forma:
 *    QUOTE
 * 
