/*
 * ***********************************************
 * Objetivo:     Carrega as funções JS dos Cardapios
 *               
...
var objCardapios = function() {
    return {
        ...
        fnOpenFormEdit: function(id) {
            ...
            var dados = eval("(" + $("#hddCardapio" + id).val() + ")");

            /* ATRIBUI OS VALORES */
            $("#txtNome").val(dados.titulo);
            $("#txtPreco").val(dados.breve_descr);
            $("#sltTipos").val(dados.cor);
            $("#hddID").val(id);
        ...
        fnTipo: function(obj) {
            ...
            //id_tipo 21 comidas - tab tipos
            //id_tipo 22 bebidas - tab tipos
            var id_tipo = $(obj).attr('value');
