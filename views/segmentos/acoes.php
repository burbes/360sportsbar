...
/*
 * ***********************************************
 * Objetivo:     Açoes do Cadastro de Segmentos
...
switch ($acao) {
    ...
    case 'Inserir':
        ...
        if ($_FILES['file']['name'] != null) {
            $file = Segmentos::carregaArquivo($condicoes);
    ...
    case 'Atualizar':
         ...
         * [dirType]: MOVER PARA PASTA DE IMAGENS */
        $condicoes = Array("ID_SEGMENTO" => $_POST['ID_SEGMENTO'], "sqlInjection" => FALSE, "dirType" => 'img');
        ...
        if ($_POST && !isset($file['result']) || ($file['result'] == true && $_POST)) {
            ...
            $ok = Segmentos::atualizar($_POST, $condicoes);
        } else
            return false;
    ...
    case 'Remover':
        /* CONDIÇÕES PARA ATUALIZAR */
        $id = Array("ID_SEGMENTO" => $_POST['ID_SEGMENTO']);

        /* FÇ ATUALIZA OS DADOS */
        $ok = Segmentos::remover($id);
