...
/*
 * ***********************************************
 * Objetivo:     Formulário de Cadastro de Automação e Tec.
 *               
...
<form action="" method="post" name="autotec_form" style="display: none;"  enctype="multipart/form-data" >
    ...
    <fieldset>
        ...
        <table class="w100p">
            ...
            <label for="sltSegmentos">Segmentos:</label>
            <select name="ID_SEGMENTO" id="sltSegmentos">
                <option value=''></option>
    ...
    <!-- BOTÃO LIMPAR -->
    <input type="reset" id="btnLimpar" value="Limpar" onclick="objAutoTec.fnResetForm()" />
